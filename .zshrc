...
alias ll='ls -lhp'
alias cp='cp -i'
alias mdlabbook='perl /Users/milan/mdlabbook/src/mdlabbook.pl -c ~/lab-notebook/mdlabbook.config'
...
alias Bioc3.12='R_LIBS_USER=~/Library/R/4.0-Bioc-3.12/library R'
...
plugins=(git git-flow git-flow-completion colored-man-pages python extract z)
